...
class Paginacion {
    ...
    public function enlace_anterior() { // compurebo si podemos ir una pagina anterior y lo genera
        $html = '';
    ...
    public function numeros_paginas() { // muestra numero de paginas
        $html = '';
        for($i = 1; $i <= $this->total_paginas(); $i++) {
            if($i === $this->pagina_actual ) { // estilos distintos a la pagina actual
    ...
    public function paginacion() { // imprime la pagina anteior, siguiente 
        $html = '';
