...
class RegistroController
{
    ...
    public static function conferencias(Router $router)
    {
        ...
        // SE COMENTA YA QUE LA PARTE DE PAYPAL ACTUAL ES DISTINTO
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            // Obtener el registro de usuario- DA ERROR PORQUE NO EM ANDA CON PAYPAL
            $registro = Registro::where('usuario_id', $_SESSION['id']);
            if (!isset($registro) || $registro->paquete_id !== "1") {
                echo json_encode(['resultado' => false]);
                return;
            ...
            foreach ($eventos as $evento_id) {
                ...
                // si llega hasta aca es porque existe el evento y hay lugares disponibles
                // se almacena en otra variable para evitar tantas consultas a la db
            ...
            foreach ($eventos_array as $evento) {
                ...
                // Almacenar el registro RELACION M A M
                $datos = [
